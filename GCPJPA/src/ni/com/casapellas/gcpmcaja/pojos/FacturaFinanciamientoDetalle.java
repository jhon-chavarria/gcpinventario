 ...
 *
 */
public class FacturaFinanciamientoDetalle {
	...
	private int cuotaSiguientePago;
	...
	public int getCuotaSiguientePago() {
		return cuotaSiguientePago;
	}
	public void setCuotaSiguientePago(int cuotaSiguientePago) {
		this.cuotaSiguientePago = cuotaSiguientePago;
	}
