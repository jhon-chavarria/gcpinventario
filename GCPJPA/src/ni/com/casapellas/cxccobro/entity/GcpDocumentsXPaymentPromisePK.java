 ...
 */
@Embeddable
public class GcpDocumentsXPaymentPromisePK implements Serializable {
	...
	public GcpDocumentsXPaymentPromisePK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof GcpDocumentsXPaymentPromisePK)) {
			return false;
		}
		GcpDocumentsXPaymentPromisePK castOther = (GcpDocumentsXPaymentPromisePK)other;
		return 
